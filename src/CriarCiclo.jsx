...
function CriarCiclo() {
  ...
  const handleSubmit = (e) => {
    ...
    // Aqui você pode salvar o ciclo ou redirecionar
    alert("Ciclo salvo com sucesso!");
    goTo("./ciclo-revisao.html");
  };
    ...
    <div className="container">
      ...
      <main>
        <form className="ciclo-form" onSubmit={handleSubmit}>
            ...
            <div className="funcionarios-cards">
              <label className="funcionario-card">
                <input
                  ...
                  onChange={() => handleFuncionarioChange("ana.souza@email.com")}
                />
                <div>
              ...
              <label className="funcionario-card">
                <input
                  ...
                  onChange={() => handleFuncionarioChange("carlos.lima@email.com")}
                />
                <div>
              ...
              <label className="funcionario-card">
                <input
                  ...
                  onChange={() => handleFuncionarioChange("juliana.alves@email.com")}
                />
                <div>
          ...
          <button type="submit" className="main-btn">Salvar Ciclo</button>
        </form>
      </main>
